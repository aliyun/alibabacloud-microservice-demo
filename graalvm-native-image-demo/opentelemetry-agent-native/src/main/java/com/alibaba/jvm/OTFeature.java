...
public class OTFeature implements Feature {
    ...
    public void beforeAnalysis(BeforeAnalysisAccess a) {
        for (Pair<Class<?>, Class<?>> virtualFieldClassPair : virtualFieldClassPairs) {
            String virtualFieldClassName = GeneratedVirtualFieldNamesDelegate.getVirtualFieldImplementationClassName(virtualFieldClassPair.getLeft().getTypeName(),
            ...
            try {
                ...
                System.out.println("Warning: Can't find " + virtualFieldClassName + "#getVirtualField(Class,Class) method");
            }
        }
    }
}
